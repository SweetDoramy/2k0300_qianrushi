...
options = {
  ...
  provide_odom_frame = true, -- 是否发布cartographer的里程计
  ...
  odometry_sampling_ratio = 0.2, -- 里程计采样比例(如果里程计精度低，可以减小该设置值)
  fixed_frame_pose_sampling_ratio = 0.1, -- 参考坐标系采样比例
  imu_sampling_ratio = 0.05,-- imu采样比例
...
TRAJECTORY_BUILDER_2D.missing_data_ray_length = 5. -- 缺失数据的射线长度
